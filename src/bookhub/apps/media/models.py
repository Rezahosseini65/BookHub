...
from bookhub.apps.media.exceptions import DuplicateImageException


# Create your models here.
class Image(models.Model):
    title = models.CharField(_('Title'), max_length=64, blank=True, null=True)
    image = models.ImageField(_('Image'), width_field='width', height_field='height', upload_to='images/books/')
